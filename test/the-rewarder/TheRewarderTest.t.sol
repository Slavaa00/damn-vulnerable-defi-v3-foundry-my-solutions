...
contract TheRewarderTest is BaseTest {
    ...
    function test_ExploitTheRewarder() public {
        runTest();
    }
    ...
    function exploit() internal override {
        ...
        // BalanceOf can be easily gamed with million methods.
        // Nothing to add to this test(
    ...
    function success() internal override {
        ...
        assertEq(accountingToken.balanceOf(attacker), 0);
    }
}
