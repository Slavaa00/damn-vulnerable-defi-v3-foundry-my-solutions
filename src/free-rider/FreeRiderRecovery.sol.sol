...
contract FreeRiderRecovery is ReentrancyGuard, IERC721Receiver {
    ...
    error CallerNotNFT();
    error OriginNotBeneficiary(address beneficiary);
    ...
    function onERC721Received(
        ...
        // Foundry working bad woth tx.origin and msg.sender
        // if (tx.origin != beneficiary) revert OriginNotBeneficiary(tx.origin);
